...
<svelte:head>
	...
	<meta name="twitter:site" content="@meetlily" />
	<meta name="twitter:creator" content="@meetlily" />
	<meta name="twitter:image" content="https://meetlily.org/images/twitter-thumbnail.jpg" />
	<meta property="twitter:domain" content="learn.meetlily.org" />
	<meta property="twitter:url" content="https://learn.meetlily.org" />

	<meta property="og:title" content="{data.exercise.title} • Svelte Tutorial" />
	<meta property="og:url" content="https://learn.meetlily.org" />
	<meta property="og:type" content="website" />
	<meta property="og:image" content="https://meetlily.org/images/twitter-thumbnail.jpg" />
</svelte:head>
